...
namespace Colder.CommonUtil
{
    public static partial class Extention
    {
        ...
        /// </summary>
        /// <param name="obj">对象</param>
        /// <param name="Iscn">是不是汉语</param>
        /// <returns></returns>
        public static string GetTimeStr(this DateTime obj,bool Iscn=false)
        {
            var Now = DateTime.Now;
            if (obj.Year == Now.Year && obj.Month == Now.Month)
            {
                var day = obj.Day - Now.Day;
                switch (day)
                {
                    case 0:
                        return (Iscn ? "今天 " : "Today ") + obj.ToString("HH:mm:ss");
                    case 1:
                        return (Iscn ? "明天 " : "Tomorrow ") + obj.ToString("HH:mm:ss");
                    default:
                        return obj.ToString("MM-dd HH:mm:ss");
                }
            }
        ...
        /// List文本集合转可分割字符串
        /// </summary>
        /// <param name="list">文本集合</param>
        /// <param name="Split">分割符</param>
        /// <returns></returns>
        public static string GetListStr(this System.Collections.Generic.List<string> list, char Split) {
            string str = "";
        ...
        /// 解决Url中特殊符号
        /// </summary>
        /// <param name="Url">文本集合</param>
        /// <returns></returns>
        public static string GetSureUrl(this string Url)
        {
            Url = Url.Replace("%", "%25");
            Url = Url.Replace("+", "%2B");
            Url = Url.Replace(" ", "%20");
